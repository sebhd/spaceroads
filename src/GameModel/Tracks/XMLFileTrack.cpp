...
XMLFileTrack::XMLFileTrack(Application* a_app) : AbstractTrack(a_app) {
	...
	for(TiXmlElement* taElem = trackElem->FirstChildElement("Atom"); taElem != NULL; taElem = taElem->NextSiblingElement("Atom")) {
		 ...
		 SolidTrackAtom* ta = new SolidTrackAtom(game::BoundingBox(cml::vector3d(x, y, z), cml::vector3d(sizex, sizey, sizez)));
